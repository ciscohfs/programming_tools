this tool can install vscode python git and .... 
add new application in new version...
...
run in linux :
just write (bash programming_tool.sh) or (./programming_tool.sh) in terminal to run tool